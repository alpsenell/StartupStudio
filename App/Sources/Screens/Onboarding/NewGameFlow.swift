...
struct NewGameFlow: View {
    ...
    private var customStep: some View {
        StepHeadline(
            title: String(localized: "A company on your terms", comment: "Onboarding page heading"),
            detail: String(localized: "Seed, stakes, rivals and cash. A custom company earns achievements but does not post to leaderboards.", comment: "Onboarding page subheading under the heading above")
        )
    }
    ...
    private var heirloomsStep: some View {
        StepHeadline(
            title: String(localized: "One thing from the last company", comment: "Onboarding page heading"),
            detail: String(localized: "A person, a perk, or the deed. It carries once, and a company that carries one is unranked.", comment: "Onboarding page subheading under the heading above")
        )
    }

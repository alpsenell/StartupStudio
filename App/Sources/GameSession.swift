...
final class GameSession {
    ...
    /// given difficulty, keeping the default founder. Used by the endings
    /// screens, which offer a difficulty but not the whole flow.
    func startNewGame(difficulty: Difficulty) {
        replaceEngine { Self.makeFreshEngine(difficulty: difficulty) }
    }
